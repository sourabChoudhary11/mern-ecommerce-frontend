...
const Dashboard = () => {
  ...
  const latestTransaction: DataType[] = stats?.latestTransaction.map(i => ({
    _id: i._id as string,
  ...
  return isLoading ? <Loader /> : isError ? <h2>Fetching Error</h2> : (
